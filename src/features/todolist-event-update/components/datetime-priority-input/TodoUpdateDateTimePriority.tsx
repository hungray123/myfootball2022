...
const TodoUpdateDateTimePriority: React.FC<IEventPickerInput> = (props: IEventPickerInput) => {
  ...
  const disabled = props.disableCondition ? props.disableCondition : false;
...
export default TodoUpdateDateTimePriority;
