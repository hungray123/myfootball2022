...
const PriorityButton: React.FC<IPriorityButton> = ({ label, color, value, onPress }: IPriorityButton) => {
  const level: string = useAppSelector(state => state.createCalendarState.level);
